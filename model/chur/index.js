...
var Chur = /** @class */ (function (_super) {
    __extends(Chur, _super);
    function Chur(options) {
    ...
    Chur.prototype.support = function (model) {
        switch (model) {
    ...
    Chur.prototype.askStream = function (req, stream) {
