...
var OpenAI = /** @class */ (function (_super) {
    ...
    function OpenAI(options) {
        ...
        _this.client = (0, proxyAgent_1.CreateAxiosProxy)({
            baseURL: (options === null || options === void 0 ? void 0 : options.base_url) || 'https://api.openai.com/',
            headers: {
                'Content-Type': 'application/json',
                accept: 'text/event-stream',
                'Cache-Control': 'no-cache',
                'Proxy-Connection': 'keep-alive',
                Authorization: "Bearer ".concat((options === null || options === void 0 ? void 0 : options.api_key) || ''),
            },
        }, false, !!(options === null || options === void 0 ? void 0 : options.proxy));
        return _this;
    }
    OpenAI.prototype.support = function (model) {
        return Number.MAX_SAFE_INTEGER;
    };
    OpenAI.prototype.askStream = function (req, stream) {
