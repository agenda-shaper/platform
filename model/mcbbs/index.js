...
var Mcbbs = /** @class */ (function (_super) {
    __extends(Mcbbs, _super);
    function Mcbbs(options) {
    ...
    Mcbbs.prototype.support = function (model) {
        switch (model) {
    ...
    Mcbbs.prototype.askStream = function (req, stream) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.client.post('/openai/v1/chat/completions', data, {
                                responseType: 'stream',
                            })];
                    case 2:
                        res = _a.sent();
                        res.data.pipe(event_stream_1.default.split(/\r?\n\r?\n/)).pipe(event_stream_1.default.map(function (chunk, cb) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_b) {
                                ...
                                _a = data.choices[0].delta.content, content = _a === void 0 ? '' : _a;
