...
var Gra = /** @class */ (function (_super) {
    __extends(Gra, _super);
    function Gra(options) {
    ...
    Gra.prototype.support = function (model) {
        switch (model) {
    ...
    Gra.prototype.ask = function (req) {
    ...
    Gra.prototype.askStream = function (req, stream) {
        return __awaiter(this, void 0, void 0, function () {
            var data, res, e_1;
            var _this = this;
            return __generator(this, function (_a) {
