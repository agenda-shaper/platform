...
var ChatBase = /** @class */ (function (_super) {
    ...
    ChatBase.prototype.support = function (model) {
        switch (model) {
    ...
    ChatBase.prototype.askStream = function (req, stream) {
                ...
                switch (_a.label) {
                    case 0:
                        data = {
                            ...
                            conversationId: "y4-".concat((0, utils_1.randomStr)(10), "-chatbase--1--pdf-p680fxvnm"),
                        };
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.client.post('/fe/chat', data, {
                                responseType: 'stream',
                            })];
                    case 2:
                        res = _a.sent();
