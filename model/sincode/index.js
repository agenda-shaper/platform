...
var SinCode = /** @class */ (function (_super) {
    __extends(SinCode, _super);
    function SinCode(options) {
        ...
        _this.pagePool = new puppeteer_1.BrowserPool(+(process.env.SINCODE_POOL_SIZE || 0), _this, false, 10 * 1000, false);
        return _this;
    }
    SinCode.prototype.support = function (model) {
        switch (model) {
    ...
    SinCode.prototype.deleteID = function (id) {
        this.accountPool.delete(id);
    };
    SinCode.prototype.release = function (id) {
        this.accountPool.release(id);
    };
    SinCode.prototype.newID = function () {
        var account = this.accountPool.get();
        return account.id;
    };
    SinCode.prototype.init = function (id, browser, options) {
        return __awaiter(this, void 0, void 0, function () {
            var account, page, loginText, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        account = this.accountPool.getByID(id);
                        if (!(!account || !account.email || !account.password)) return [3 /*break*/, 3];
                        return [4 /*yield*/, browser.close()];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, (0, utils_1.sleep)(24 * 60 * 60 * 1000)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/, []];
                    ...
                    case 8:
                        _a.sent();
                        return [4 /*yield*/, page.goto("https://www.sincode.ai/app")];
                    case 9:
                        _a.sent();
                        return [4 /*yield*/, page.waitForSelector('.cnaBeaI > .bubble-element > div > font > strong')];
                    case 10:
                        _a.sent();
                        return [4 /*yield*/, page.evaluate(function () {
                                // @ts-ignore
                                return document.querySelector('.cnaBeaI > .bubble-element > div > font > strong').textContent || '';
                            })];
                    case 11:
                        loginText = _a.sent();
                        if (!(loginText.indexOf('Login') !== -1)) return [3 /*break*/, 13];
                        return [4 /*yield*/, page.click('.cnaBeaI > .bubble-element > div > font > strong')];
                    case 12:
                        _a.sent();
                        _a.label = 13;
                    case 13: return [4 /*yield*/, page.waitForSelector('.bubble-element:nth-child(1) > .bubble-r-container:nth-child(1) > .bubble-element:nth-child(1) > .bubble-element:nth-child(2) > .bubble-element:nth-child(1) > .bubble-element:nth-child(2)')];
                    case 14:
                        _a.sent();
                        return [4 /*yield*/, page.click('.bubble-element:nth-child(1) > .bubble-r-container:nth-child(1) > .bubble-element:nth-child(1) > .bubble-element:nth-child(2) > .bubble-element:nth-child(1) > .bubble-element:nth-child(2)')];
                    case 15:
                        _a.sent();
                        return [4 /*yield*/, page.type('.bubble-element:nth-child(1) > .bubble-r-container:nth-child(1) > .bubble-element:nth-child(1) > .bubble-element:nth-child(2) > .bubble-element:nth-child(1) > .bubble-element:nth-child(2)', account.email, { delay: 20 })];
                    case 16:
                        _a.sent();
                        return [4 /*yield*/, page.waitForSelector('#pw_login')];
                    case 17:
                        _a.sent();
                        return [4 /*yield*/, page.click('#pw_login')];
                    case 18:
                        _a.sent();
                        return [4 /*yield*/, page.type('#pw_login', account.password, { delay: 10 })];
                    case 19:
                        _a.sent();
                    ...
                    case 21:
                        _a.sent();
                        return [4 /*yield*/, page.goto("https://www.sincode.ai/app/marve")];
                    case 22:
                        _a.sent();
                    ...
                    case 23:
                        if (!(_a.sent())) {
                            ...
                            throw new Error("account:".concat(account === null || account === void 0 ? void 0 : account.email, ", no login status"));
                        }
                        return [4 /*yield*/, this.newChat(page)];
                    case 24:
                        _a.sent();
                        return [4 /*yield*/, this.isVIP(page)];
                    case 25:
                        if (!(_a.sent())) {
                            account.vip = false;
                            this.logger.error("account ".concat(account.email, " is not VIP, deleted ok!"));
                            this.accountPool.syncfile();
                            return [2 /*return*/, []];
                        }
                        return [4 /*yield*/, this.closeOldChat(page)];
                    case 26:
                        _a.sent();
                        return [4 /*yield*/, this.newChat(page)];
                    case 27:
                    ...
                    case 28:
                        ...
                        account.failedCnt += 1;
                        this.accountPool.syncfile();
                        return [4 /*yield*/, (0, utils_1.sleep)(Math.floor(Math.random() * 5 * 60 * 1000))];
                    case 29:
                        _a.sent();
                        return [2 /*return*/, []];
    ...
    SinCode.prototype.newChat = function (page) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    SinCode.prototype.isLogin = function (page) {
        return __awaiter(this, void 0, void 0, function () {
            var e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    SinCode.prototype.closeFirstChat = function (page) {
        return __awaiter(this, void 0, void 0, function () {
            var e_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                        return [4 /*yield*/, page.waitForSelector('.clickable-element > .bubble-element > .clickable-element:nth-child(2) > #unselectable > img', { timeout: 5 * 1000 })];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, page.click('.clickable-element > .bubble-element > .clickable-element:nth-child(2) > #unselectable > img')];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, page.waitForSelector('.clickable-element > .bubble-element > .clickable-element:nth-child(2) > #unselectable > img', { timeout: 5 * 1000 })];
                    case 3:
    ...
    SinCode.prototype.closeOldChat = function (page) {
        return __awaiter(this, void 0, void 0, function () {
            var e_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, page.$('#scrollbar > * > div > div.bubble-element.Text.cnaQai0.clickable-element')];
                    case 2:
                        if (!_a.sent()) return [3 /*break*/, 7];
                        return [4 /*yield*/, page.waitForSelector('#scrollbar > * > div > div.bubble-element.Text.cnaQai0.clickable-element', { timeout: 5000 })];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, page.click('#scrollbar > * > div > div.bubble-element.Text.cnaQai0.clickable-element')];
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, page.waitForSelector('#scrollbar > * > div > div.bubble-element.Text.cnaQai0.clickable-element', { timeout: 5000 })];
                    case 5:
                    ...
                    case 6:
                        _a.sent();
                        return [3 /*break*/, 12];
                    case 7: return [4 /*yield*/, page.waitForSelector('.clickable-element > .bubble-element > .clickable-element:nth-child(2) > #unselectable > img', { timeout: 5 * 1000 })];
                    case 8:
                        _a.sent();
                        return [4 /*yield*/, page.click('.clickable-element > .bubble-element > .clickable-element:nth-child(2) > #unselectable > img')];
                    case 9:
                    ...
                    case 11:
                        _a.sent();
                        _a.label = 12;
                    case 12: return [4 /*yield*/, (0, utils_1.sleep)(50)];
                    case 13:
                        _a.sent();
                        return [3 /*break*/, 15];
                    case 14:
    ...
    SinCode.prototype.isVIP = function (page) {
        return __awaiter(this, void 0, void 0, function () {
            var e_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    SinCode.prototype.changeMode = function (page, model) {
    ...
    SinCode.prototype.askStream = function (req, stream) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, page, account, done, destroy, client, tt, old, et, currMsgID_1, ok, e_7;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                                ...
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        ...
                                        case 1:
                                            ...
                                            tt.refresh();
                                            if (!(dataStr.indexOf('xxUNKNOWNERRORxx') !== -1)) return [3 /*break*/, 4];
                                            client.removeAllListeners('Network.webSocketFrameReceived');
                                            clearTimeout(tt);
                                            this.logger.error("sincode return error, ".concat(dataStr));
                                            return [4 /*yield*/, this.closeFirstChat(page)];
                                        case 2:
                                            _b.sent();
                                            return [4 /*yield*/, this.newChat(page)];
                                        case 3:
                                        ...
                                        case 4:
                                            ...
                                            if (!(dataStr.indexOf('DONE') !== -1)) return [3 /*break*/, 7];
                                            client.removeAllListeners('Network.webSocketFrameReceived');
                                            clearTimeout(tt);
                                            stream.write(utils_1.Event.done, { content: '' });
                                            stream.end();
                                        ...
                                        case 8:
                                            e_8 = _b.sent();
                                            this.logger.error("handle msg failed, dataStr:".concat(dataStr, ", err:"), e_8);
                                            return [3 /*break*/, 9];
                    ...
                    case 10:
                        ...
                        client.removeAllListeners('Network.webSocketFrameReceived');
                        clearTimeout(tt);
                        this.logger.error("account: id=".concat(account.id, ", sincode ask stream failed:"), e_7);
                        account.failedCnt += 1;
