...
var Google = /** @class */ (function (_super) {
    ...
    Google.prototype.newPage = function () {
        return __awaiter(this, void 0, void 0, function () {
            var page;
    ...
    Google.prototype.support = function (model) {
        switch (model) {
    ...
    Google.prototype.askStream = function (req, stream) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, page.goto("https://www.google.com.hk/search?q=".concat(req.prompt, "+&hl=zh-CN"), { waitUntil: 'domcontentloaded' })];
                    case 5:
                        _b.sent();
                        return [4 /*yield*/, page.waitForSelector('.g')];
                    case 6:
                        _b.sent();
                        return [4 /*yield*/, page.evaluate(function () {
                                ...
                                nodes.forEach(function (node) {
                                    var titleNode = node.querySelector('h3');
                                    var linkNode = node.querySelector('.yuRUbf a');
                                    var descriptionNode = node.querySelector('.VwiC3b');
