...
var Vita = /** @class */ (function (_super) {
    __extends(Vita, _super);
    function Vita(options) {
    ...
    Vita.prototype.support = function (model) {
        switch (model) {
    ...
    Vita.prototype.askStream = function (req, stream) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.client.post('/converse-edge', data, {
                                responseType: 'stream',
                            })];
                    case 2:
                        res = _a.sent();
