...
var PWeb = /** @class */ (function (_super) {
    __extends(PWeb, _super);
    function PWeb(options) {
    ...
    PWeb.prototype.support = function (model) {
        switch (model) {
    ...
    PWeb.prototype.askStream = function (req, stream) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        res = _a.sent();
                        res.data.pipe(event_stream_1.default.map(function (chunk, cb) {
