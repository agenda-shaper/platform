...
exports.Better = void 0;
var base_1 = require("../base");
var proxyAgent_1 = require("../../utils/proxyAgent");
var event_stream_1 = require("event-stream");
var utils_1 = require("../../utils");
var modelMap = (_a = {},
    _a[base_1.ModelType.GPT3p5_16k] = 'gpt-3.5-turbo-16k',
    _a[base_1.ModelType.GPT4] = 'gpt-4',
    _a[base_1.ModelType.GPT3p5Turbo] = 'gpt-3.5-turbo',
    _a);
var Better = /** @class */ (function (_super) {
    __extends(Better, _super);
    ...
    Better.prototype.support = function (model) {
        switch (model) {
    ...
    Better.prototype.askStream = function (req, stream) {
