...
var modelMap = (_a = {},
    ...
    _a[base_1.ModelType.GPT3p5_16k] = { id: "gpt-3.5-turbo-16k", name: "GPT-3.5-TURBO-16K" },
    _a[base_1.ModelType.GPT3p5Turbo] = {
        id: "gpt-3.5-turbo",
        name: "GPT-3.5-TURBO"
    },
    _a);
var VVM = /** @class */ (function (_super) {
    __extends(VVM, _super);
    function VVM(options) {
    ...
    VVM.prototype.support = function (model) {
        switch (model) {
    ...
    VVM.prototype.ask = function (req) {
        return __awaiter(this, void 0, void 0, function () {
            var stream, res, result;
    ...
    VVM.prototype.askStream = function (req, stream) {
        return __awaiter(this, void 0, void 0, function () {
            var data, res, e_1;
            var _this = this;
            return __generator(this, function (_a) {
